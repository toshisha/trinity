...
export default function MusicPlayer() {
  ...
  }, [isShuffled, filteredTracks, tracks, shuffleArray])
            ...
            <div className="text-center py-8 opacity-60">
              {searchQuery ? (
                ...
                <>
                  ...
                  <p className="text-xs mt-1">Add audio files to the public/music directory to get started</p>
                </>
              )}
            </div>
          ) : (
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-1/3 flex items-center justify-end gap-2">
              ...
              <input
                ...
                className="w-24 h-1 bg-white/10 rounded-full overflow-hidden appearance-none"
              />
            </div>
          </div>
        </div>
